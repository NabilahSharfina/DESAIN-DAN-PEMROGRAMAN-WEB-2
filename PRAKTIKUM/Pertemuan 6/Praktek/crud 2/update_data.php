...
$sql_mahasiswa = "SELECT * FROM data WHERE id=" . $_GET['mahasiswa_id']; // SQL SELECT STATEMENT + GET method
$data_mahasiswa = $conn -> query($sql_mahasiswa); // Connection into query "$sql_mahasiswa"
